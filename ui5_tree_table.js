          ...
          <mvc:View
              ...
              <m:Page showHeader="false" enableScrolling="false" class="sapUiContentPadding">
                  <m:content>
                      ...
                      <Table id="oTable" rows="{path'/' , parameters: {arrayNames:['TableData']}}" selectionMode="Single" selectionBehavior="RowOnly" visibleRowCount="15" sort="sortProductId" ariaLabelledBy="title" >
                          <extension>
