        ...
        <script id="oView" name="oView" type="sapui5/xmlview">
           <mvc:View xmlns:mvc="sap.ui.core.mvc" xmlns="sap.ui.table" xmlns:core="sap.ui.core" xmlns:dnd="sap.ui.core.dnd" xmlns:m="sap.m" xmlns:u="sap.ui.unified" controllerName="myView.Template" height="100%">
              <m:Page showHeader="false" enableScrolling="false">
                 <m:content>
                    <TreeTable id="TreeTable" rows="{/spl}" selectionMode="MultiToggle" enableSelectAll="false" ariaLabelledBy="title">
                       <extension>
                                             ...
                                             { "spl": [
                                                     {"name":"LH4 - Customer 1", "spl": [
                                                       ...
                                                       {"name": "LH4 - Customer 2", "spl": [
                                                         {"name": "MPL 4", "amount": 24.99, "currency": "USD", "size": "M"},
                                                         {"name": "MPL 5", "amount": 14.99, "currency": "USD", "size": "S"}
                                                       ]},
                                                       {"name": "LH4 - Customer 3", "spl": [
                                                         {"name": "MPL 6", "amount": 32.99, "currency": "USD", "size": "M"},
                                                         {"name": "MPL 7", "amount": 44.99, "currency": "USD", "size": "S"},
                                                         {"name": "MPL 8", "amount": 99.99, "currency": "USD", "size": "XS"},
                                                         {"name": "MPL 9", "amount": 56.99, "currency": "USD", "size": "L"}
                                                       ]},
